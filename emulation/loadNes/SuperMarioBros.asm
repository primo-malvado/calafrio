...
reset:      SEI                ; $8000: 78        
            CLD                ; $8001: d8        
            LDA #%00010000           ; $8002: a9 10     
            STA PPUCTRL          ; $8004: 8d 00 20  
            LDX #$ff           ; $8007: a2 ff     
            TXS                ; $8009: 9a        
__800a:     LDA PPUSTATUS          ; $800a: ad 02 20  
            BPL __800a         ; $800d: 10 fb      ;Branch on Result Plus
__800f:     LDA PPUSTATUS          ; $800f: ad 02 20  
            BPL __800f         ; $8012: 10 fb     
            LDY #$fe           ; $8014: a0 fe     
            LDX #$05           ; $8016: a2 05     
__8018:     LDA $07d7,x        ; $8018: bd d7 07  
            CMP #%00001010           ; $801b: c9 0a     
...
__809e:     STA $0779          ; $809e: 8d 79 07  
            AND #$e7           ; $80a1: 29 e7     
            STA PPUMASK          ; $80a3: 8d 01 20  
            LDX PPUSTATUS          ; $80a6: ae 02 20  
...
__813d:     LDA PPUSTATUS          ; $813d: ad 02 20  
            AND #%01000000           ; $8140: 29 40     
...
__8150:     LDA PPUSTATUS          ; $8150: ad 02 20  
            AND #%01000000           ; $8153: 29 40     
            BEQ __8150         ; $8155: f0 f9     
            LDY #$14           ; $8157: a0 14     
__8159:     DEY                ; $8159: 88        
            BNE __8159         ; $815a: d0 fd     
__815c:     LDA $073f          ; $815c: ad 3f 07  
            STA PPUSCROLL          ; $815f: 8d 05 20  
            LDA $0740          ; $8162: ad 40 07  
            STA PPUSCROLL          ; $8165: 8d 05 20  
            LDA $0778          ; $8168: ad 78 07  
            PHA                ; $816b: 48        
            STA PPUCTRL          ; $816c: 8d 00 20  
            LDA $0776          ; $816f: ad 76 07  
            LSR                ; $8172: 4a        
            BCS __8178         ; $8173: b0 03     
            JSR __8212         ; $8175: 20 12 82  
__8178:     LDA PPUSTATUS          ; $8178: ad 02 20  
            PLA                ; $817b: 68        
            ORA #%10000000           ; $817c: 09 80     
            STA PPUCTRL          ; $817e: 8d 00 20  
            RTI                ; $8181: 40        
...
__819d:     LDA $06fc          ; $819d: ad fc 06  
            AND #%00010000           ; $81a0: 29 10     
            BEQ __81bd         ; $81a2: f0 19     
            LDA $0776          ; $81a4: ad 76 07  
            AND #%10000000           ; $81a7: 29 80     
...
__848d:     AND #%01000000           ; $848d: 29 40     
...
;-------------------------------------------------------------------------------
            ...
            LDA #$1e           ; $8704: a9 1e     
            STA PPUADDR          ; $8706: 8d 06 20  
            LDA #$c0           ; $8709: a9 c0     
            STA PPUADDR          ; $870b: 8d 06 20  
            LDA #$03           ; $870e: a9 03     
            STA $01            ; $8710: 85 01     
            LDY #$00           ; $8712: a0 00     
            STY $00            ; $8714: 84 00     
            LDA PPUDATA          ; $8716: ad 07 20  
__8719:     LDA PPUDATA          ; $8719: ad 07 20  
            STA ($00),y        ; $871c: 91 00     
            INY                ; $871e: c8        
...
__8831:     ORA ($03,x)        ; $8831: 01 03     
            ...
            CLC                ; $883f: 18        
            ADC #$01           ; $8840: 69 01     
__8842:     CMP #%00001010           ; $8842: c9 0a     
            BCC __884d         ; $8844: 90 07     
            SBC #%00001010           ; $8846: e9 0a     
            LDY #$9f           ; $8848: a0 9f     
...
;-------------------------------------------------------------------------------
__8e19:     LDA PPUSTATUS          ; $8e19: ad 02 20  
            LDA $0778          ; $8e1c: ad 78 07  
            ORA #%00010000           ; $8e1f: 09 10     
            AND #$f0           ; $8e21: 29 f0     
            JSR __8eed         ; $8e23: 20 ed 8e  
            LDA #$24           ; $8e26: a9 24     
            JSR __8e2d         ; $8e28: 20 2d 8e  
__8e2b:     LDA #$20           ; $8e2b: a9 20     
__8e2d:     STA PPUADDR          ; $8e2d: 8d 06 20  
            LDA #$00           ; $8e30: a9 00     
            STA PPUADDR          ; $8e32: 8d 06 20  
            LDX #$04           ; $8e35: a2 04     
            LDY #$c0           ; $8e37: a0 c0     
            LDA #$24           ; $8e39: a9 24     
__8e3b:     STA PPUDATA          ; $8e3b: 8d 07 20  
            DEY                ; $8e3e: 88        
            BNE __8e3b         ; $8e3f: d0 fa     
            DEX                ; $8e41: ca        
            BNE __8e3b         ; $8e42: d0 f7     
            LDY #%01000000           ; $8e44: a0 40     
            TXA                ; $8e46: 8a        
            STA $0300          ; $8e47: 8d 00 03  
            STA $0301          ; $8e4a: 8d 01 03  
__8e4d:     STA PPUDATA          ; $8e4d: 8d 07 20  
            DEY                ; $8e50: 88        
...
;-------------------------------------------------------------------------------
__8e92:     STA PPUADDR          ; $8e92: 8d 06 20  
            INY                ; $8e95: c8        
            LDA ($00),y        ; $8e96: b1 00     
            STA PPUADDR          ; $8e98: 8d 06 20  
            INY                ; $8e9b: c8        
            LDA ($00),y        ; $8e9c: b1 00     
            ASL                ; $8e9e: 0a        
            PHA                ; $8e9f: 48        
...
__8ebb:     STA PPUDATA          ; $8ebb: 8d 07 20  
            DEX                ; $8ebe: ca        
            ...
            STA $01            ; $8ecb: 85 01     
            LDA #$3f           ; $8ecd: a9 3f     
            STA PPUADDR          ; $8ecf: 8d 06 20  
            LDA #$00           ; $8ed2: a9 00     
            STA PPUADDR          ; $8ed4: 8d 06 20  
            STA PPUADDR          ; $8ed7: 8d 06 20  
            STA PPUADDR          ; $8eda: 8d 06 20  
__8edd:     LDX PPUSTATUS          ; $8edd: ae 02 20  
            LDY #$00           ; $8ee0: a0 00     
            LDA ($00),y        ; $8ee2: b1 00     
            BNE __8e92         ; $8ee4: d0 ac     
__8ee6:     STA PPUSCROLL          ; $8ee6: 8d 05 20  
            STA PPUSCROLL          ; $8ee9: 8d 05 20  
            RTS                ; $8eec: 60        

;-------------------------------------------------------------------------------
__8eed:     STA PPUCTRL          ; $8eed: 8d 00 20  
...
__9054:     LDA #%10000000           ; $9054: a9 80     
            STA $fb            ; $9056: 85 fb     
            LDA #$01           ; $9058: a9 01     
...
__959d:     LDX #%00010000           ; $959d: a2 10     
            LDA ($e7),y        ; $959f: b1 e7     
            CMP #$fd           ; $95a1: c9 fd     
...
;-------------------------------------------------------------------------------
            ...
            LDX #$01           ; $99e7: a2 01     
__99e9:     LDA #%01000000           ; $99e9: a9 40     
...
;-------------------------------------------------------------------------------
__b559:     LDA #%00001010           ; $b559: a9 0a     
...
__b83b:     LDA #%00010000           ; $b83b: a9 10     
            STA $00            ; $b83d: 85 00     
            LDA #$01           ; $b83f: a9 01     
...
__bcbd:     ORA __d4c6,y       ; $bcbd: 19 c6 d4  
            ...
            LDA #%00010000           ; $bcc8: a9 10     
            STA $58,x          ; $bcca: 95 58     
            LDA #%10000000           ; $bccc: a9 80     
            STA $23            ; $bcce: 85 23     
            ASL                ; $bcd0: 0a        
...
;-------------------------------------------------------------------------------
__c851:     LDA #%00010000           ; $c851: a9 10     
...
__cfc1:     BEQ __cfdd         ; $cfc1: f0 1a     
            AND #%01000000           ; $cfc3: 29 40     
            BEQ __cfcd         ; $cfc5: f0 06     
            LDA $cf,x          ; $cfc7: b5 cf     
            CMP #$e0           ; $cfc9: c9 e0     
            BCC __cfd7         ; $cfcb: 90 0a     
__cfcd:     LDA #%10000000           ; $cfcd: a9 80     
...
__d932:     LDX $0756          ; $d932: ae 56 07  
            ...
            LDA #%00010000           ; $d93f: a9 10     
            STA $ff            ; $d941: 85 ff     
            JSR __85f1         ; $d943: 20 f1 85  
            LDA #%00001010           ; $d946: a9 0a     
...
__def0:     LDA $0b            ; $def0: a5 0b     
            ...
            LDA $01            ; $defc: a5 01     
            CMP #%00010000           ; $defe: c9 10     
            BNE __df52         ; $df00: d0 50     
            LDA #$28           ; $df02: a9 28     
            STA $06de          ; $df04: 8d de 06  
            LDA #$03           ; $df07: a9 03     
            STA $0e            ; $df09: 85 0e     
            LDA #%00010000           ; $df0b: a9 10     
            STA $ff            ; $df0d: 85 ff     
...
__df66:     LDX #$02           ; $df66: a2 02     
            ...
            LDA #$01           ; $df6c: a9 01     
__df6e:     LDY #%00010000           ; $df6e: a0 10     
...
;-------------------------------------------------------------------------------
__e1fc:     LDA #%10000000           ; $e1fc: a9 80     
            STA $24,x          ; $e1fe: 95 24     
            LDA #$02           ; $e200: a9 02     
            STA $ff            ; $e202: 85 ff     
            RTS                ; $e204: 60        
...
__eade:     LDA $036a          ; $eade: ad 6a 03  
            ...
            ORA #%01000000           ; $eaf1: 09 40     
            CPX #$05           ; $eaf3: e0 05     
            BNE __eaf9         ; $eaf5: d0 02     
            ORA #%10000000           ; $eaf7: 09 80     
...
__ec28:     LDX $08            ; $ec28: a6 08     
            ...
            ORA #%01000000           ; $ec2d: 09 40     
            STA $0206,y        ; $ec2f: 99 06 02  
            ORA #%10000000           ; $ec32: 09 80     
...
__ee27:     ORA #%00001010           ; $ee27: 09 0a     
...
__f3c0:     LDA #%01000000           ; $f3c0: a9 40     
...
__f400:     LDA #%00001010           ; $f400: a9 0a     
            LDY #$93           ; $f402: a0 93     
...
__f5fd:     LDA #%00010000           ; $f5fd: a9 10     
...
;-------------------------------------------------------------------------------
__f681:     LDA #%01000000           ; $f681: a9 40     
...
__f6d0:     LDY #%00010000           ; $f6d0: a0 10     
...
__f8ba:     LDA #%00010000           ; $f8ba: a9 10     
