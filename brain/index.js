...
var trainData = [];
for(var i = 0; i< list.length-50; i = i+17)
{
...
net.train(trainData, {
      ...
      momentum: 0.21,        // scales with next layer's change value --> number between 0 and 1
...
var pos = 985; var test = list.filter(function(a,index, c, d){return index > pos-(len-1) && index < pos;}); //console.log(test)
var output = net.run(test);  // list[pos] = 1.4
console.log(list[pos], output);



  pos = 976; var test = list.filter(function(a,index, c, d){return index > pos-(len-1) && index < pos;}); //console.log(test)
  output = net.run(test);  // list[pos] = 1.4
console.log(list[pos], output);


  pos = 968; var test = list.filter(function(a,index, c, d){return index > pos-(len-1) && index < pos;}); //console.log(test)
  output = net.run(test);  // list[pos] = 1.4
console.log(list[pos], output);
